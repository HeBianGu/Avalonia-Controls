...
//        public static object GetDataContext(this Control element)
//        {
//            return element is Control framework ? framework.DataContext : null;
//        }

//        public static object GetContent(this Control element)
//        {
//            if (element is ContentPresenter cp)
//                return cp.Content;
//            if (element is ContentControl cc)
//                return cc.Content;
//            if (element is Control fe)
//                return fe.DataContext;
//            return null;
//        }

//        public static T GetItemsSource<T>(this Control element) where T : IEnumerable
//        {
